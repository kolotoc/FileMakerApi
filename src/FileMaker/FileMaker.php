...
// TODO resolve defining from outside the class file
...
/**
 * Base src class. Defines database properties, connects to a database,
...
class FileMaker
{
     ...
     *
     * @public FileMaker_Implementation
     * @access private
     */
    public $_impl;

    /**
     * Tests whether a variable is a src API Error.
     *
    ...
    /**
     * Returns the version of the src API for PHP.
     *
     ...
     *
     * <samp>
     * new src('DatabaseName', NULL, 'username', 'password');
     * </samp>
     *
     * @param string $database Name of the database to connect to.
     * @param string $hostspec Hostspec of web server in src Server
     ...
     *
     * <samp>
     * <IMG src="img.php?-url=<?php namespace Kolotoc\FileMakerApi;   echo urlencode($record->getField('Cover Image')); ?>">
     * </samp>
     *
     * Then as shown below in a line from img.php, pass the URL into
     * getContainerData() for the src object named $fm:
     *
     * <samp>
     ...
     *
     * <samp>
     * <IMG src="<?php namespace Kolotoc\FileMakerApi;   echo $fm->getContainerDataURL($record->getField('Cover Image')); ?>">
     * </samp>
     *
     * @param string $url URL of the container field contents to get.
     *
