 ...
 * Create this command with {@link src::newFindCommand()}.
 *
 * @package src
 */
class FileMaker_Command_Find extends FileMaker_Command
{
     ...
     * the settings specified in the src Pro Portal Setup dialog box.
     *
     * @param string $relatedsetsfilter Specify one of these values to
     *        control filtering:
     *        - 'layout': Apply the settings specified in the src Pro
