 ...
 * src/conf/filemaker-api.php configuration file where the API is
...
class FileMaker_Record
{
     ...
     *
     * @public FileMaker_Record_Implementation
     * @access private
     */
    public $_impl;
     ...
     * src Server Admin Console. If pre-validation passes, validate()
