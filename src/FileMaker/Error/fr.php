...
/**
 * src error codes - French translations.
 *
 * @package src
 *
...
$__FM_ERRORS = array(
    ...
    403 => 'Le nombre maximal d\'enregistrements indiqué est atteint pour la version de démonstration src Pro',
    ...
    412 => 'Version de src Pro incorrecte pour récupérer le fichier',
    ...
    806 => 'Le fichier ne peut être ouvert avec cette version de src Pro',
    807 => 'Le fichier n\'est pas un fichier src Pro ou est sérieusement endommagé',
    ...
    811 => 'Un fichier temporaire ne peut être ouvert en tant que fichier src Pro',
    ...
    824 => 'Le fichier est endommagé ou n\'est pas un fichier src',
    ...
    904 => 'Cette commande ne peut être utilisée que dans un fichier se trouvant sur le serveur src Server',
    ...
    1400 => 'L\'initialisation du pilote ODBC a échoué ; assurez-vous que les pilotes ODBC sont correctement installés. Remarque Le module de partage des données via ODBC s\'installe automatiquement avec src Server ; les pilotes clients ODBC s\'installent à l\'aide du CD-ROM de la Publication Web de src Server. Pour plus d\'informations, consultez la rubrique Installation des pilotes src sur les clients ODBC et JDBC.',
