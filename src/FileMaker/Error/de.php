...
/**
 * src error codes - German translations.
 *
 * @package src
 *
...
$__FM_ERRORS = array(
    ...
    403 => 'Maximales Datensatzlimit für src Pro-Demo wird überschritten.',
    ...
    412 => 'Falsche Version von src Pro verwendet, um die Datei wiederherzustellen',
    ...
    806 => 'Datei kann mit dieser Version von src Pro nicht geöffnet werden.',
    807 => 'Datei ist keine src Pro-Datei oder ist schwer beschädigt.',
    808 => 'Datei kann wegen beschädigter Zugriffsrechte nicht geöffnet werden.',
    809 => 'Datenträger voll',
    810 => 'Datenträger fixiert',
    811 => 'Temporärdatei kann nicht als src Pro-Datei geöffnet werden.',
    ...
    824 => 'Datei ist beschädigt oder keine src-Datei.',
    ...
    904 => 'Befehl kann nur in einer Datei verwendet werden, die von src Pro Server freigegeben wurde.',
    ...
    1400 => 'ODBC-Client-Treiberinitialisierung fehlgeschlagen. Stellen Sie sicher, dass die ODBC-Client-Treiber richtig installiert sind. Hinweis Die Plugin-Komponente für das Bereitstellen von Daten über ODBC wird automatisch zusammen mit src Server installiert. Die ODBC-Client-Treiber werden über die src Server Web Publishing-CD installiert. Weitere Informationen finden Sie in Installation der src ODBC- und JDBC-Client-Treiber.',
