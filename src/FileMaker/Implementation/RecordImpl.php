        ...
        switch ($V06e3d36f->getResult()) {
            case 'date':
                ...
                if (count($V78f0805f) != 3) {
                    return new FileMaker_Error($this->_fm, 'Failed to parse "' . $V2063c160 . '" as a src date value.');
                }
            ...
            case 'time':
                $V78f0805f = explode(':', $V2063c160);
                if (count($V78f0805f) != 3) {
                    return new FileMaker_Error($this->_fm, 'Failed to parse "' . $V2063c160 . '" as a src time value.');
                }
