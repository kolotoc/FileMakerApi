...
class FileMaker_Implementation
{
    ...
    function getContainerData($V9305b73d)
    {
        if (!function_exists('curl_init')) {
            return new FileMaker_Error($this, 'cURL is required to use the src API.');
        }
    ...
    function _execute($Vf7cc8e48, $Vb3d1bd6a = 'fmresultset')
    {
        ...
        if ($V70106d0d = curl_errno($Vd88fc6ed)) {
            ...
            if ($V70106d0d == 52) {
                return new FileMaker_Error($this, 'Communication Error: (' . $V70106d0d . ') ' . curl_error($Vd88fc6ed) . ' - The Web Publishing Core and/or src Server services are not running.', $V70106d0d);
